        ...
        active: function() {
            $4f25f79d22c7c45d$var$selectFrom.addEventListener('change', (e)=>{
                ...
                $4f25f79d22c7c45d$var$inputText.addEventListener('change', ()=>{
                    ...
                    if (textvalue === "") $4f25f79d22c7c45d$var$createCanva("C", shape, sizeVal, fontColor, bgColor, font);
                    else $4f25f79d22c7c45d$var$createCanva(textvalue, shape, sizeVal, fontColor, bgColor, font);
                });
            });
        }
    });
